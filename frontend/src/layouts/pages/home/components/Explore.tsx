            ...
            <div className="mt-5 bg-fixed px-3">
                <div className="pt-3">
                    <div className="card rounded-4 m-md-5 m-sm-0 col-md-6 col-sm-12 main-text-dark d-flex align-items-center">
                        <div className="p-4">
                            <h3 className="fw-semibold">What sets your dental office apart from others?</h3>
                            <p>Our dental office stands out due to our commitment to personalized care. We prioritize patient comfort and utilize cutting-edge technology to deliver precise and efficient treatments. Our team's expertise, combined with a welcoming environment, ensures a stress-free and enjoyable dental experience.</p>
                        </div>
                    </div>
                </div>
